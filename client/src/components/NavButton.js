const NavButton = (props) => {
  return (
    <a href={props.url} className='text-white fill-white text-center lg:text-left p-2 flex flex-col lg:flex-row content-center w-1/3 hover:text-sky-500 hover:fill-sky-500'>
